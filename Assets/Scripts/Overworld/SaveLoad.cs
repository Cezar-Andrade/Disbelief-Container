...
public static class SaveLoad
{
    ...
    public static bool LoadAlMighty()
    {
        ...
        else
        {
            ...
            BinaryFormatter bf = new BinaryFormatter();
            string locFile;
            if (Application.platform == RuntimePlatform.WindowsEditor || Application.platform == RuntimePlatform.WindowsPlayer) {locFile = "C:/Users/" + System.Environment.UserName + "/AppData/LocalLow/Nobody's Getting Paid Here/Create Your Frisk/AlMightySave.gd"; }
            else if (Application.platform == RuntimePlatform.OSXEditor || Application.platform == RuntimePlatform.OSXPlayer) {locFile = "~/Library/Application Support/Nobody's Getting Paid Here/Create Your Frisk/AlMightySave.gd"; }
            else { locFile = "$XDG_CONFIG_HOME/unity3d/Nobody's Getting Paid Here/Create Your Frisk/AlMightySave.gd"; }
